...
**Grading:** Lose 1 pt if incorrect notation (missing $\varepsilon$, adding hats, etc.)
...
**Grading:** 1 pt for fitting models, 1 pt for test statistic, 1 pt for p-value, 1 pt for conclusion. It is ok if they calculate the test statistic by hand.
...
**Grading:** 1 pt for degrees of freedom, 1 pt for test statistic, 1 pt for p-value
...
**Grading:** 2 pts for CI, 1 pt for interpretation. Other confidence levels are allowed
